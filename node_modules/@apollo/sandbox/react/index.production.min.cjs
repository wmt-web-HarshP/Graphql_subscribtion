...
var EmbeddedSandbox = require('../EmbeddedSandbox.production.min.cjs');
...
function ApolloSandboxReact(props) {
  ...
  React.useEffect(() => {
    ...
    currentEmbedRef.current = new EmbeddedSandbox.EmbeddedSandbox(Object.assign(Object.assign({}, props), {
...
exports.ApolloSandbox = ApolloSandboxReact;
